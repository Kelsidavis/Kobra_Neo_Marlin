...
/**
 * lcd/extui/anycubic_kobra_neo/kobra_neo_extui.cpp
 *
 * Anycubic Kobra Neo DGUS-style serial display driver bridge for Marlin's
 * ExtUI. Mirrors anycubic_vyper/vyper_extui.cpp with the Kobra-Neo-specific
 * dgus_tft.{h,cpp} (which includes additional menu pages — probe preheat,
 * leveling flow, abnormal-bed pages — that the Vyper driver doesn't have).
 */
...
namespace ExtUI {
  ...
  void onPostprocessSettings() { dgus.paramInit(); }
