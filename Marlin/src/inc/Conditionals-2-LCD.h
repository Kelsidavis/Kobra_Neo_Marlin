...
#if !DGUS_UI_IS(NONE) || ANY(ANYCUBIC_LCD_VYPER, ANYCUBIC_LCD_KOBRA_NEO)
...
#define LCD_ENABLED_COUNT 0 \
  ...
  + COUNT_ENABLED(ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, ANYCUBIC_TFT35, ANYCUBIC_LCD_VYPER, ANYCUBIC_LCD_KOBRA_NEO) \
