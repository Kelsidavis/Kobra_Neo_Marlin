...
#define STRING_CONFIG_H_AUTHOR "(Kobra Neo upstream port)" // Original author or contributor.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ANYCUBIC_KOBRA_NEO
#endif
...
// Display is SPI TFT — no serial LCD port needed.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_KI 0.5444
    #define DEFAULT_KD 66.87
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  101.12
  #define DEFAULT_BED_KI   10.8912
  #define DEFAULT_BED_KD  625.89
...
// Individual pullups — NOT global, because the PNP-NO probe needs pullDOWN.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.630, 80.030, 406.000, 398.00 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3500, 3500, 150, 2000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 37.5, 0, -1.66 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
// HC32 HAL has no tone() — keep this disabled and the buzzer will work
// as a fixed-frequency on/off click via BEEPER_PIN.
//
//#define SPEAKER
...
// Reused for Kobra Neo (same Anycubic DGUS-style serial protocol family).
// A Kobra-Neo-specific driver port (with extra menu pages) is staged in
// extui/anycubic_kobra_neo/ but not yet API-adapted to Marlin 2.1.x.
//
//#define ANYCUBIC_LCD_VYPER

//#define ANYCUBIC_LCD_KOBRA_NEO
 ...
 */
// TFT_NO_ROTATION keeps TFT_EXCHANGE_XY set in the final TFT_ORIENTATION
// (via XOR with TFT_DEFAULT_ORIENTATION which has EXCHANGE_XY). This gives
// landscape mode: TFT_WIDTH=320, TFT_HEIGHT=240. The actual MADCTL (0xB0)
// is forced in st7789v.h for our board.
